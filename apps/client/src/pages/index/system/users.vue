    ...
    >
      <NForm label-placement="left" :show-feedback="false">
        <NGrid cols="1 640:12 1024:24" item-responsive :x-gap="16" :y-gap="12">
          ...
          <NFormItemGi label="部门" span="1 640:6 1024:5" class="min-w-0">
            <NTreeSelect
          ...
          <NFormItemGi label="角色" span="1 640:5 1024:5" class="min-w-0">
            <NSelect
          ...
          <NFormItemGi label="状态" span="1 640:3 1024:3" class="min-w-0">
            <NSelect
          ...
          <NGridItem suffix span="1 640:4 1024:5">
